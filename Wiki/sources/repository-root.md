...
- Why it matters: the root contains the public README and the main project directories.
- Key points:
...
- Update triggers:
  - New tracked files.
  - Changes to repo structure, pipeline scope, data policy, or governance policy.
